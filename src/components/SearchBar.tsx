...
const SearchBar = () => {
  ...
  return (
    <Card elevation={0} sx={{display:"flex", width:"800px", height:"48px", backgroundColor:"#eaeaea", alignItems:"center"}}>
      <Stack direction="row" spacing={2} alignItems="center" marginX={2} width="100%" >
        <SearchIcon sx={{ fontSize: 20, color:"#7f7f7f" }} />
        <InputBase fullWidth placeholder={placeholder} value={searchTerm} onChange={handleSearchTermChange} onKeyDown={handleKeyDown} />
      </Stack>
    </Card>
  );
};
